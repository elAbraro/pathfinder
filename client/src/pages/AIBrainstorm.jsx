    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8 h-[calc(100vh-100px)] flex flex-col">
            <div className="text-center mb-6 shrink-0">
                ...
                <p className="text-slate-500 text-sm">Your personal guide for the application journey</p>
            </div>
            ...
            <div className="flex-grow bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                ...
                <form onSubmit={handleSend} className="p-4 bg-white border-t border-slate-200 flex gap-2">
                    <input
                        ...
                        className="flex-grow rounded-xl border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent px-4 py-3"
                    />
                    <button
                        type="submit"
